        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 font-sans">
              Step into the future of campus tours with our immersive 3D experience. 
              Explore, learn, and connect with UWindsor like never before.
            </p>
            <div className="flex flex-wrap gap-4">
              <button className="group relative px-8 py-3 bg-gradient-to-r from-yellow-400 to-yellow-600 rounded-full">
                <span className="relative z-10 text-blue-900 font-bold">Start Exploring</span>
          ...
          >
            <div className="relative w-full aspect-square rounded-2xl overflow-hidden border border-white/10 backdrop-blur-sm bg-white/5">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <p className="text-lg text-gray-300">Interactive Preview Coming Soon</p>
              </div>
