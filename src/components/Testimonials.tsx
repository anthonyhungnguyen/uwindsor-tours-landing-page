  ...
  const testimonials = [
    {
      ...
      quote: "The UWindsor Tours platform made it so easy for me to navigate campus during my first week. I was able to familiarize myself with all the buildings before even arriving on campus!",
    },
    {
      id: 2,
      ...
      quote: "As an international student, I wasn't able to visit campus before making my decision. The virtual tour gave me a real sense of what life at UWindsor would be like.",
    },
    {
      id: 3,
      ...
      quote: "I recommend UWindsor Tours to all my incoming students. It's incredibly detailed and helps students find their way around campus with ease. A fantastic technological improvement for our university.",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Hear from students, faculty, and visitors who have experienced UWindsor Tours
          </p>
        </motion.div>
            ...
            <div className="flex flex-col items-center">
              ...
              >
                ...
                <cite className="not-italic">
                  ...
                  <p className="text-yellow-400">{testimonials[activeIndex].role}</p>
                </cite>
              </motion.div>
            </div>
