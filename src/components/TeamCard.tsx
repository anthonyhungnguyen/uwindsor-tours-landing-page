  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-xl backdrop-blur-sm bg-white/5 border border-white/10 p-6 transition-transform hover:scale-105">
        <div className={`absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-${gradientFrom} to-transparent`}></div>
        <div className="flex flex-col items-center">
          <div className="w-32 h-32 rounded-full overflow-hidden mb-4 border-2 border-white/20">
            <div className={`w-full h-full bg-gradient-to-br from-${gradientFrom} to-${gradientTo} flex items-center justify-center`}>
          ...
          <p className="text-gray-300 text-center mb-4 font-sans">{description}</p>
